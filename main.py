...
async def on_message(message):
    ...
    if (message.author != bot.user): # votka doesnt respond to its own messages
        ...
        # birthday
        if ("ddWMk" in message.content):
            await message.channel.send("From our birthday, until we die,\nIs but the winking of an eye.")
            await message.channel.send("Happy birthday mom!")
